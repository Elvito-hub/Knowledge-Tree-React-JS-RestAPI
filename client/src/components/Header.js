...
class Header extends React.Component{
    ...
    renderLogo=()=>{
        let PATH={
           knowledgeIcon:{
               icon:".knowledge-icon",
               disk1:".knowledge-icon .disk1",
               disk2:".knowledge-icon .disk2",
               disk3:".knowledge-icon .disk3"
  ...
  anime({
    targets: [`${PATH.knowledgeIcon.icon}`],
    ..._revealVert(150, "easeOutElastic", 100),
    complete:function(){
        const disk1 = document.querySelector(PATH.knowledgeIcon.disk1);
        disk1.style.transformOrigin = "50% 50%";
        const disk2 = document.querySelector(PATH.knowledgeIcon.disk2);
        disk2.style.transformOrigin = "50% 50%";
        const disk3 = document.querySelector(PATH.knowledgeIcon.disk3);
        disk3.style.transformOrigin = "50% 50%";
        anime({
            targets:[`${PATH.knowledgeIcon.disk1}`,`${PATH.knowledgeIcon.disk3}`],
            rotate:"360deg",
            duration:"5000",
            loop:true,
            easing:'linear',
        ...
        anime({
            targets:`${PATH.knowledgeIcon.disk2}`,
            rotate:"-360deg",
            duration:"5000",
            loop:true,
            easing:'linear',
        ...
        return(
        <div style={{backgroundColor:'lightblue'}} className="icon knowledge-icon">
              <svg  enableBackground="new 0 0 512 512" height="90" viewBox="0 0 512 512" width="100" xmlns="http://www.w3.org/2000/svg"> 
                ...
                <path d="M477.994,125.391c-8.63-29.327-26.529-55.069-51.016-73.371c-48.142-37.762-93.15-53.416-145.8-50.725
                    ...
                    <g className="disk1" style={{transformBox: "fill-box"}}>
                ...
                <g className="disk2" style={{transformBox: "fill-box"}}>
                ...
                <g className="disk3" style={{transformBox: "fill-box"}}>
    ...
    renderHistory(){
        if(this.props.isSignedIn){
            return <Link style={{color:'white'}} to="/userhistory"><div className="histbutton"><h3>History</h3></div></Link>
        }else{
            return null;
        }
    }
        ...
        return (
            <div className="head">
                <div className="logo">
                    ...
                    <Link style={{color:'white',paddingLeft:'10px'}} to="/"><h1 className="thehead">Knowledge Tree</h1></Link>
                </div>
               <div className="rightmenu">
                   {this.renderHistory()}
                   <div className="loginbutton"><GoogleAuth/></div>
               </div>
            </div>
        )
    }
...
const mapStateToProps=(state)=>{
    return{isSignedIn:state.auth.isUserSignedIn}
}
